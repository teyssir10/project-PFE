...
const difficultyColor: Record<string, string> = {
  ...
  Medium:
    "!bg-cyan-200 !text-cyan-700 !border-cyan-300 dark:!bg-cyan-800/40 dark:!text-cyan-200 dark:!border-cyan-600",
            ...
            {loadingActivity ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-400 text-xs mt-1">
                  Play your first quiz to see it here
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                {recentActivity.map((item, i) => {
                  const percent = item.quizzes?.question_count
                    ? Math.round(
                        (item.score / item.quizzes.question_count) * 100,
                      )
                    : 0;
                  ...
                  <div className="space-y-4">
                    {recommendedQuizzes.map((quiz, i) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <Tag
                            className={`!rounded-full !text-xs !font-semibold ${difficultyColor[quiz.difficulty]}`}
                          >
                            {quiz.difficulty}
                          </Tag>
                          <Button
