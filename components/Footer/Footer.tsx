  ...
  const footerSections = [
    {
      titleKey: 'company',
      links: [
        { key: 'contact', labelKey: 'contactUs', href: '/contact' },
      ],
    },
    {
      titleKey: 'support',
      links: [
        { key: 'help', labelKey: 'helpCenter', href: '/help' },
        { key: 'privacy', labelKey: 'privacyPolicy', href: '/privacy' },
      ],
    },
  ];
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <div className='grid grid-cols-1 md:grid-cols-5 gap-8'>
          ...
          {footerSections.map((section) => (
            <div key={section.titleKey} className='col-span-1'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
          <p className='text-gray-500 text-sm text-center md:text-left'>
            © {currentYear} QuizMaster. {t('rights')}
          </p>
        </div>
      </div>
    </footer>
