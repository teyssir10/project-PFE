          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20">
                ...
                <span className="text-sm font-semibold text-[#00D4D0]">{t('badge')}</span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="large" variant="outlined" className="!rounded-xl !px-8 !font-semibold !border-2 !text-[#00D4D0] !border-[#00D4D0]">
                {t('learnMore')}
              </Button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-border">
              <div>
                ...
                <p className="text-sm text-gray-500">{t('stats.quizzes')}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">{t('stats.satisfaction')}</p>
              </div>
            </div>
          </div>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                <div className="w-full max-w-sm space-y-4 p-6 rounded-2xl bg-white dark:bg-slate-900 shadow-xl border border-cyan-500/10">
                  <div className="space-y-2">
                    <p className="text-sm font-semibold text-[#00D4D0]">{t('question')}</p>
                    <h3 className="text-lg font-bold">{t('questionText')}</h3>
                  </div>
                  <div className="space-y-2">
                    {['China', 'Africa', 'America', 'Europe'].map((option, i) => (
                      <button
                        key={i}
                        className={`w-full p-3 rounded-lg text-left font-medium transition-all ${
                          i === 0
                            ? 'bg-cyan-500/20 border-2 border-[#00D4D0]'
                  ...
                  <button className="w-full py-2 rounded-lg bg-[#0F596E] text-white font-semibold">
                    {t('nextQuestion')}
                  </button>
                </div>
              </div>
